"""
  ...
  Usage:
    Results = GMCA(X,n=2,maxts = 7,mints=3,nmax=100,L0=0,UseP=1,verb=0,Init=0,Aposit=False,BlockSize= None,NoiseStd=[],IndNoise=[],Kmax=0.5,AInit=None,tol=1e-6,ColFixed=None)
  ...
  Inputs:
   ...
   ColFixed : m x p fixed spectra (p spectra are fixed, they correspond the p first columns)
...
def GMCA(X,n=2,maxts = 7,mints=3,nmax=100,L0=0,UseP=1,verb=0,Init=0,Aposit=False,BlockSize= None,NoiseStd=[],IndNoise=[],Kmax=1.,AInit=None,tol=1e-6,ColFixed=None):
    ...
    S,A = Core_GMCA(X=Xw,A=A,S=S,n=n,maxts=maxts,BlockSize = BlockSize,Aposit=Aposit,tol=tol,kend = mints,nmax=nmax,L0=L0,UseP=UseP,verb=verb,IndNoise=IndNoise,Kmax=Kmax,NoiseStd=NoiseStd,ColFixed=ColFixed)
...
def Core_GMCA(X=0,n=0,A=0,S=0,maxts=7,kend=3,nmax=100,BlockSize = 2,L0=1,Aposit=False,UseP=0,verb=0,IndNoise=[],Kmax=0.5,NoiseStd=[],tol=1e-6,ColFixed=None):
